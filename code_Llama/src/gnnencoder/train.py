...
def main(args):
    # 只用训练集作为检索数据集
    task_path = {'ASPE': '/home/zhubin/WorkSpace/Finllm_fin_3090/data/gnn_data/inst/ASPE/train_org.json',
                 'MEMD_AS': '/data02/zzunlp/liuhd/FaiMA/data/inst/MEMD/AS/train.json',
                 'MEMD_AOS': '/data02/zzunlp/liuhd/FaiMA/data/inst/MEMD/AOS/train.json',
                 'MEMD_ACOS': '/data02/zzunlp/liuhd/FaiMA/data/inst/MEMD/ACOS/train.json',

                 
                 'FinEntity':'/home/zhubin/WorkSpace/Finllm_fin_3090/data/gnn_data/FinEntity/train_gnn.json',
                 'SEntFiN':'/home/zhubin/WorkSpace/Finllm_fin_3090/data/gnn_data/SEntFiN/train_gnn.json',
                 'EFSA':'/home/zhubin/WorkSpace/Finllm_fin/data_3090/gnn_data/EFSA/train_gnn.json'
                 }

    if args.task not in ['FinEntity', 'SEntFiN', 'EFSA', 'ASPE', 'MEMD_AS', 'MEMD_AOS', 'MEMD_ACOS']:
